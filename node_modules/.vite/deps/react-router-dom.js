...
var Link = A2(function LinkWithRef(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = A2(function NavLinkWithRef(_ref8, ref) {
  let {
...
var Form = A2((_ref9, forwardedRef) => {
  let {
    fetcherKey,
    navigate,
    reloadDocument,
